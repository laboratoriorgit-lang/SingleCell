...
|   |-- umap_annotation_biblio.pdf
|   `-- clustree_annotated.pdf
|-- 04_expression/
|   |-- feature_gene_<gene>.pdf
|   `-- vln_gene_<gene>.pdf
|-- 05_curation/
|   |-- umap_grouped.pdf
|   |-- subcluster_markers_<cluster>.pdf
|   `-- umap_curated.pdf
|-- objects/                              # checkpoints (.rds / .h5ad)
|   |-- seurat_list_postfilter.rds
|   |-- ath_sc_preharmony.rds
|   |-- ath_sc_postharmony.rds
|   |-- ath_sc_curated.rds
|   |-- ath_sc_curated.h5ad
|   |-- pseudobulk_replicates/
|   `-- ath_sc_pseudotime_final.h5ad
|-- 06_de_results/<comparison_tag>/       # e.g. WT_vs_pifq/
|   |-- DESeq2_<cell_type>_<tag>.csv
|   |-- <cell_type>_<tag>_filtered.csv
|   |-- diff_table_<tag>_fc1_padj_005.tsv
|   |-- log2FC_table_fc1_padj_005.tsv
|   |-- heatmap_<tag>.pdf
|   `-- volcano/
|       |-- DESeq2_<cell_type>_<tag>.png
|       `-- VolcanoPlots_<tag>.pdf
|-- 07_go/<comparison_tag>/
|   |-- GO_<cell_type>_<tag>_BP.tsv
|   `-- GO_<cell_type>_<tag>_BP_bubble.pdf
|-- 08_networks/
|   |-- edges_unified.tsv
|   |-- nodes_unified.tsv
|   |-- modules_unified.tsv
|   |-- hubgenes_unified.tsv
|   |-- hdwgcna_summary.tsv
|   |-- unified_TOM.rda
|   |-- hdwgcna_unified.rds
...
`-- 09_pseudotime/
    |-- umap_overview.pdf
    |-- umap_selection.pdf
    `-- trajectory/<run_name>/            # e.g. n50_s0.3_l200_e3_seed3/
        |-- parameters.tsv
        |-- <run_name>_annotation.pdf
        |-- <run_name>_pseudotime_trajectory.pdf
        |-- <run_name>_root_cell.pdf
        |-- <run_name>_pseudotime_by_cell.tsv
        |-- <run_name>_trajectory.h5ad
        |-- gene_plots/<run_name>_gene_plots.pdf
        `-- gene_trends/
            |-- step29_gene_trends_top10_FINAL_24x18.pdf
            `-- step29_gene_trends_highlight_list_FINAL_24x18.pdf
```
